...
?>
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
<p>Disclaimer: The Login Portal is only required for access to the new group/subgroup registration service. All other features of the CpnClassiPhyR are available without the requirement of a user account.</p>		
