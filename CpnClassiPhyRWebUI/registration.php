<?php
    ...
    if (isset($_REQUEST['email'])){
        ...
        if($rows == 1){
            ...
            if($password == $confirm){
                $query = "INSERT into users (email, firstname, lastname, academictitle, institution, country, password, trn_date)
                VALUES ('$email', '$firstname', '$lastname', '$academictitle', '$institution', '$country', '".md5($password)."', '$trn_date')";
