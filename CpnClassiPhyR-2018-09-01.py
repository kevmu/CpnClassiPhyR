        ...
        for fasta_record in SeqIO.parse(query_infile, "fasta"):
            ...
            if(p_status == 0):
                ...
                if(is_phytoplasma == "true"):
                    ...
                    elif((((align_length >= 552) and (align_length <= 555)) and (percent_identity >= 70)) and (len(qseq) < 604)):
